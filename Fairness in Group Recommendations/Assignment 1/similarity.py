...
def manhattan_similarity(matrix, input_user, other_user):
    # Implementation of the "Manhattan Similarity" formula
    input_coratings, other_coratings = list(), list()
    ...
    denominator = np.sum(np.abs(input_coratings - other_coratings))
